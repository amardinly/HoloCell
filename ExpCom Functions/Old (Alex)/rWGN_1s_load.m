...
ExpStruct.currentrWGNrandomlightparams=str2num(get(h.custom_sequence,'String'));
    ...
    ExpStruct.bufferloadcounter=80; 
...
if ExpStruct.bufferloadcounter==80;
...
ExpStruct.whitenoiseframeorder(:,workingsweep) = randi(400,[1 20])+ExpStruct.playstart;
...
ExpStruct.LEDoutput1(thisStart:thisEnd)=5;
end
